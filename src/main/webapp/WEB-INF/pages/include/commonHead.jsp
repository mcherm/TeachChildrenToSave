<%-- contains common items to go in the head section --%>
...
<link href="<c:url value="tcts/css/master.css" />" rel="stylesheet">
...
<!--[if lt IE 9]>
<link rel="stylesheet" href="tcts/css/ie8.css"/> <%-- IE8 only stylesheet, because you know we love ie8 --%>
<![endif]-->