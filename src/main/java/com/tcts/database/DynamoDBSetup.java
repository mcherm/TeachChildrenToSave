...
public class DynamoDBSetup {
    ...
    public static abstract class DataInserter {
        ...
        public DataInserter(DynamoDBDatabase.Tables tables) {
            this.tables = tables;
        }
        ...
        public void insertUser(String passwordSalt, String passwordHash, String email,
            ...
            dynamoDBHelper.insertIntoTable(tables.userTable,
                    new ItemMaker(user_id, dynamoDBHelper.createUniqueId())
                            ...
                            .withString(user_email, email.toLowerCase())
                            .withString(user_original_email, email)
    ...
    public static class RealDataInserter extends DataInserter {
        public RealDataInserter(DynamoDBDatabase.Tables tables) {
            super(tables);
        }
        ...
        public void run() {
            ...
            insertAllowedTime("10:00 to 10:45 AM", 2);
            insertAllowedTime("10:30 to 11:15 AM", 3);
            insertAllowedTime("11:00 to 11:45 AM", 4);
            insertAllowedTime("11:30 AM to 12:15 PM", 5);
            insertAllowedTime("12:00 to 12:45 PM", 6);
            insertAllowedTime("12:30 to 1:15 PM", 7);
            insertAllowedTime("1:00 to 1:45 PM", 8);
            insertAllowedTime("1:30 to 2:15 PM", 9);
            insertAllowedTime("2:00 to 2:45 PM", 10);
            insertAllowedTime("2:30 to 3:15 PM", 11);
            insertAllowedTime("3:00 to 3:45 PM", 12);
            insertAllowedTime("Flexible", 13);
            ...
            insertBank("Applied Bank", "660 Plaza Drive", "", "Newark ", "DE", "19702", null);
            insertBank("Artisan's Bank", "2961 Centerville Road", "", "Wilmington", "DE", "19808", null);
            insertBank("Bank of America", "1100 North King Street", "", "Wilmington", "DE", "19801", "BofA Internal Mail Code");
            insertBank("Barclay's Bank Delaware", "100 South West Street", "", "Wilmington", "DE", "19801", null);
            insertBank("BNY Mellon Trust of Delaware", "301 Bellevue Parkway", "Suite 19A-307", "Wilmington", "DE", "19809", null);
            insertBank("Brandywine Trust Company", "7234 Lancaster Pike", "", "Hockessin", "DE", "19707", null);
            insertBank("Brown Brothers Harriman Trust Company", "919 North Market Street", "Suite 420", "Wilmington", "DE", "19801", null);
            insertBank("Capital One", "802 Delaware Avenue", "", "Wilmington", "DE", "19801", null);
            insertBank("Charles Schwab Bank", "602 Delaware Avenue", "", "Wilmington", "DE", "19801", null);
            insertBank("Chase Bank USA", "201 North Walnut Street", "", "Wilmington", "DE", "19801", null);
            insertBank("CNB", "4580 South DuPont Highway", "", "Camden", "DE", "19934", null);
            insertBank("Comenity Bank", "1 Righter Parkway", "", "Wilmington", "DE", "19803", null);
            insertBank("Commonwealth Trust Company", "29 Bancroft Mills Road", "", "Wilmington", "DE", "19806", null);
            insertBank("Community Bank Delaware", "16982 Kings Highway", "", "Lewes", "DE", "19958", null);
            insertBank("County Bank", "19927 Shuttle Road", "", "Rehoboth Beach", "DE", "19971", null);
            insertBank("Deutsche Bank Trust Company Delaware", "1011 Centre Road", "Suite 200", "Wilmington", "DE", "19805", null);
            insertBank("Discover Bank", "12 Read's Way", "", "New Castle", "DE", "19720", null);
            insertBank("Fulton Bank", "1013 Center Road", "3rd Floor", "Wilmington", "DE", "19805", null);
            insertBank("Glenmede", "1201 North Market Street", "Suite 1501", "Wilmington", "DE", "19801", null);
            insertBank("HSBC Trust Company", "300 Delaware Avenue", "Suite 1401", "Wilmington", "DE", "19801", null);
            insertBank("JPMorgan Trust Company of Delaware", "500 Stanton Christiana Road", "", "Newark ", "DE", "19713", null);
            insertBank("Key National Trust Company of Delaware", "1105 North Market Street", "", "Wilmington", "DE", "19801", null);
            insertBank("M&T Bank", "1100 North Market Street", "", "Wilmington", "DE", "19801", null);
            insertBank("MidCoast Community Bank", "974 Justison Street", "", "Wilmington", "DE", "19801", null);
            insertBank("Morgan Stanley Private Bank", "919 North Market Street", "", "Wilmington", "DE", "19801", null);
            insertBank("PNC Bank", "222 Delaware Avenue", "", "Wilmington", "DE", "19899", null);
            insertBank("Principal Trust Company", "1013 Center Road", "", "Wilmington", "DE", "19805", null);
            insertBank("UBS Trust Company", "500 Delaware Avenue", "9th Floor", "Wilmington", "DE", "19801", null);
            insertBank("Wells Fargo Bank", "814 Philadelphia Pike", "", "Wilmington", "DE", "19809", null);
            insertBank("WSFS Bank", "500 Delaware Avenue", "", "Wilmington", "DE", "19801", null);
            ...
            insertUser("JrCGJAr4HcM=","KMcEQeRkLmdJV6lQJaSWKzkqYhM=","teach2save@udel.edu","Jennifer","Magaw","SA",null,"302-831-2544",0);
            insertUser("AjVW337bQJs=","jtZ3UlKhhAuyKpo98aGUfTiPy74=","mcherm@mcherm.com","Michael","Chermside","SA",null,"610-810-1806",0);
            insertUser("AjVW337bQJs=","jtZ3UlKhhAuyKpo98aGUfTiPy74=","rchermside@gmail.com","Rachel","Chermside","SA",null,"610-649-1319",0);
        }
    }
